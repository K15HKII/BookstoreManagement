...
{
    public partial class TransporterInfoViewModel : BaseViewModel
    {
        private readonly IViewModelFactory _factory;
        private readonly IModelRemote _model;
        private readonly ITransporterInfoNavigator _navigator;

        public TransporterInfoViewModel(ITransporterInfoNavigator navigator, [NotNull] ScheluderProvider scheluderProvider, IViewModelFactory factory, IModelRemote model) : base(scheluderProvider)
        {
            _factory = factory;
            _model = model;
