...
{
    public partial class AuthorDetailViewModel : BaseViewModel, IDialog
    {
        private readonly IModelRemote _model;
        private readonly IViewModelFactory _factory;
        private readonly IAuthorDetailNavigator _navigator;

        public AuthorDetailViewModel(IAuthorDetailNavigator navigator, [NotNull] ScheluderProvider scheluderProvider,IViewModelFactory factory, IModelRemote model) : base(scheluderProvider)
        {
        ...
        public async void OpenEdit()
        {
            ...
            object? request = await _navigator.OpenEditAuthorDialog(vm);
