...
{
    public partial class UpdateAuthorViewModel : BaseViewModel,IDialog
    {
        private readonly IModelRemote _model;

        public UpdateAuthorViewModel([NotNull] ScheluderProvider scheluderProvider, IModelRemote model) : base(scheluderProvider)
        {
            _model = model;
        }
