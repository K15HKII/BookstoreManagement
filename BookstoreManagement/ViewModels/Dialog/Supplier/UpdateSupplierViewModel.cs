...
{
    public partial class UpdateSupplierViewModel : BaseViewModel,IDialog
    {
        private readonly IModelRemote _model;

        public UpdateSupplierViewModel([NotNull] ScheluderProvider scheluderProvider, IModelRemote model) : base(scheluderProvider)
        {
            _model = model;
        }
